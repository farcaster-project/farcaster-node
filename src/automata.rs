...
// copied over from lnp-node on 2022-08-03, and adapted
    ...
    // FIXME: should be Message: Into<BusMsg> after api split
{
    ...
    pub fn complete_ctl(self, message: Message) -> Result<(), esb::Error<ServiceId>> {
        self.endpoints
            .send_to(ServiceBus::Ctl, self.service, self.source, message.into())
    }
    ...
    pub fn complete_ctl_service(
        ...
        self.endpoints
            .send_to(ServiceBus::Ctl, self.service, service, message.into())
    }
    ...
    pub fn complete_p2p_service(
        ...
        self.endpoints
            .send_to(ServiceBus::Msg, self.service, service, message.into())
    }
}
