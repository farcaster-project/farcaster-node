...
fn spawn_swap() {
    ...
    opts = Opts::parse_from(
        vec!["swap-cli"]
            ...
            .chain(vec![
                "take", "",
            ]),
    );
    opts.command
        .exec(&mut client)
