...
Register-ArgumentCompleter -Native -CommandName 'swapd' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'swapd' {
            ...
            [CompletionResult]::new('-n', 'n', [CompletionResultType]::ParameterName, 'Blockchain networks to use for the swaps (mainnet, testnet, local)')
            [CompletionResult]::new('--network', 'network', [CompletionResultType]::ParameterName, 'Blockchain networks to use for the swaps (mainnet, testnet, local)')
