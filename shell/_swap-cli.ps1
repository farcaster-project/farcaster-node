...
Register-ArgumentCompleter -Native -CommandName 'swap-cli' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'swap-cli' {
            ...
            [CompletionResult]::new('connect', 'connect', [CompletionResultType]::ParameterValue, 'Connect to the remote lightning network peer, Taker''s action')
            ...
            [CompletionResult]::new('make-offer', 'make-offer', [CompletionResultType]::ParameterValue, 'Maker creates offer and start listening. Command used to to print a hex representation of the offer that shall be shared with Taker. Additionally it spins up the listener awaiting for connection related to this offer. Example usage: `make-offer Testnet Bitcoin Monero 100000 200 10 10 20 Alice`')
            [CompletionResult]::new('take-offer', 'take-offer', [CompletionResultType]::ParameterValue, 'Taker accepts offer and connects to Maker''s daemon')
